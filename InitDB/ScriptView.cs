...
namespace InitDB
{
    public partial class ScriptView : Form
    {
        public ScriptView()
        {
            ...
            this.scintilla.Styles[Style.Sql.Word2].ForeColor = Color.DarkRed;
            ...
            this.scintilla.Styles[Style.Sql.User3].ForeColor = Color.DarkRed;
            this.scintilla.Styles[Style.Sql.User4].ForeColor = Color.DarkRed;
            ...
            this.scintilla.SetKeywords(1, "bool bit byte char short int long bigint real float varchar nvarchar varbinary uniqueidentifier datetime datetime2");
